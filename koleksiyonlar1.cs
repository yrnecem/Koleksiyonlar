    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                {
                    System.Console.WriteLine(" Pozitif ve Numeric Bir sayı Giriniz");
                }
            ...
            foreach (int item in asal)
            {
             ...
             System.Console.WriteLine("Asal Olan Sayıların Ortalaması=  " + toplam1/asal.Count+ "  Dizideki Eleman Sayısı= "+asal.Count );
